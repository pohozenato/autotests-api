...
# Фикстура для создания экземпляра PrivateUsersClient с уже настроенным HTTP-клиентом
@pytest.fixture
def private_users_client(function_user: UserFixture) -> PrivateUsersClient:
    return PrivateUsersClient(client=get_private_http_client(function_user.authentication_user))